"""
Django settings for skyori project.
...
SECRET_KEY = 'django-insecure-r7w!pts58huj(+52+j@9lvfw60m&%_&2p#h)@^!+)&#7f$i=*c'
...
WSGI_APPLICATION = 'skyori.wsgi.application'
